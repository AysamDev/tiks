...
import {Link as Slink , BrowserRouter as Router, Switch} from "react-router-dom";
...
(observer((props) => { 
      ...
      const changeSignInStatus = function()
      {
        props.UserManager.userCanSignIN = true
      }

      const handleInput = (event) =>
      {
        props.UserManager.handleInput(event)
      }
      return (
        props.UserManager.userCanSignIN?
       <Router>
          <NavBar/>
        ...
        <div className={classes.paper}>
          ...
          <Avatar className={classes.avatar}>
            ...
            <Grid container>
              ...
              <Grid item>
                <Link variant="body2">
                {<Slink to="/signup" >{"Don't have an account? Sign Up"}</Slink>}
                </Link>
              </Grid>
            </Grid>
          </form>
